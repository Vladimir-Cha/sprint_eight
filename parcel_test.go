...
func TestGetByClient(t *testing.T) {
	...
	assert.Len(t, len(parcels), len(storedParcels)) // убедитесь, что количество полученных посылок совпадает с количеством добавленных
	...
	for _, parcel := range storedParcels {
		...
		assert.EqualValues(t, parcel, parcelMap[parcel.Number])
	}
}
