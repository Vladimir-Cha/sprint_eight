...
func TestAddGetDelete(t *testing.T) {
	...
	pl, err := store.Get(number)
	require.NoError(t, err)
	assert.Equal(t, pl.Status, parcel.Status)
	assert.Equal(t, pl.Client, parcel.Client)
	assert.Equal(t, pl.CreatedAt, parcel.CreatedAt)
	assert.Equal(t, pl.Address, parcel.Address)
...
func TestSetAddress(t *testing.T) {
	...
	pl, err := store.Get(number)
	require.NoError(t, err)
	assert.Equal(t, newAddress, pl.Address)
}
...
func TestSetStatus(t *testing.T) {
	...
	status, err := store.Get(number)
	require.NoError(t, err)
	assert.Equal(t, ParcelStatusDelivered, status.Status)
