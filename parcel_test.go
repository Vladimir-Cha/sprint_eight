...
func TestSetAddress(t *testing.T) {
	...
	check_parcel, err := store.Get(id)
	require.NoError(t, err)
	// assert.NotEqual(t, check_parcel.Address, parcel.Address)
	assert.Equal(t, newAddress, check_parcel.Address)
}
...
func TestSetStatus(t *testing.T) {
	...
	check_parcel, err := store.Get(id)
	require.NoError(t, err)
	assert.Equal(t, ParcelStatusSent, check_parcel.Status)
}
